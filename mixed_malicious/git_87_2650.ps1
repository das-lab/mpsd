...
new-sqlavailabilitygrouplistener -Name $AGName -staticIP $IPs -Port 1433 -Path "SQLSERVER:\Sql\$PrimaryNode\DEFAULT\AvailabilityGroups\$AGName"function Invoke-SMBExec
{
